rem java -jar compiler.jar --compilation_level SIMPLE_OPTIMIZATIONS --js ../jquery.ui.bmap.js --js_output_file ../min/jquery.ui.bmap.min.js
rem Packer -o ../min/jquery.ui.bmap.min.js -m packer ../min/jquery.ui.bmap.min.js
...
rem java -jar compiler.jar --compilation_level SIMPLE_OPTIMIZATIONS --js ../jquery.ui.bmap.services.js --js_output_file ../min/jquery.ui.bmap.services.min.js
rem Packer -o ../min/jquery.ui.bmap.services.min.js -m packer ../min/jquery.ui.bmap.services.min.js
